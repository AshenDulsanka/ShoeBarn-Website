<?php
    ...
    echo "<body>";
        ...
        //store the value in a local variable called $kidid
        $kidid=$_GET['u_prod_id'];

        //display the value of the product id, for debugging purposes
        echo "<p>&nbsp;&nbsp;Selected product ID: ".$kidid ."<br>";
        echo "<br>";

        //create a $SQL variable and populate it with a SQL statement that retrieves product details
        $SQL="select kidID, prodName, prodPicNameLarge,prodDescripLong,prodPrice from kids WHERE kidID=".$kidid;
            ...
            while ($arrayp=mysqli_fetch_array($exeSQL))
            {
                echo "<tr>";
                    echo "<td style='border: 0px'>";
                        ...
                        //make the image into an anchor to prodbuyk.php and pass the product id by URL (the id from the array)
                    ...
                    echo "<td style='border: 0px'>";
                        ...
                        echo "<a href='formdetails.php'>";
                            echo "<br><input type=submit name='preorder' value='Pre Order' id='submitbtn'>";
                        echo "</a>";
                    echo "</td>";
                echo "</tr>";
