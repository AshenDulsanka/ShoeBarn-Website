<?php
    ...
    echo "<body>";
        ...
        //store the value in a local variable called $mensid
        $mensid=$_GET['u_prod_id'];

        //display the value of the product id, for debugging purposes
        echo "<p>&nbsp;&nbsp;Selected product ID: ".$mensid ."<br>";
        echo "<br>";

        //create a $SQL variable and populate it with a SQL statement that retrieves product details
        $SQL="select menID, prodName, prodPicNameLarge,prodDescripLong,prodPrice from mens WHERE menID=".$mensid;
