...
echo "<p>Selected product Id: ".$womanid;
//create a $SQL variable and populate it with a SQL statement that retrieves product details
$SQL="select womanID, prodName, prodPicNameLarge,prodDescripLong,prodPrice,prodQuantity from woman WHERE womanID=".$womanid;
        ...
        echo "<tr>";
            ...
            echo "</td>";
                ...
                echo "<br><p>Number to be purchased: ";
                    ...
                    echo "<input type=hidden name=h_prodid value=".$womanid.">";
                    echo "</form>";
                    echo "</p>";
